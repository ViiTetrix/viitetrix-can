...
export const themeConfig: ThemeConfig = {
  ...
  seo: {
    ...
    verification: {
      ...
      google: 'av0gIRsD8D255i1zKLXV7Nva_BCpOSB4uB9WTy1eeWc',
      // bing webmaster tools
      // https://www.bing.com/webmasters
      bing: 'FF6FF723304143F426E4EE23805C49C1',
      // yandex webmaster
    ...
    googleAnalyticsID: 'G-ZBXJGECE6K',
    // umami analytics
